...
public class WhalinTriggerMemcached2R1TBoostedClient extends DB implements JdbcDBMemCachedClientConstants {
...
//				}
	...
	public int viewProfile(int requesterID, int profileOwnerID,
		...
		try {
			if(!common.CacheUtilities.CacheSet(this.cacheclient, key, payload, false, this.TTLvalue, this.compressPayload))
			{
