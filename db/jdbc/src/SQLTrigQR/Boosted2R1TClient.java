...
//
//
//public class Boosted2R1TClient extends DB implements JdbcDBClientConstants {
...
//		
//		String cache_hostname = props.getProperty(MEMCACHED_SERVER_HOST, MEMCACHED_SERVER_HOST_DEFAULT);
//		int cache_port = Integer.parseInt(props.getProperty(MEMCACHED_SERVER_PORT, MEMCACHED_SERVER_PORT_DEFAULT));
//		
//		
//		try {
//			if (driver != null) {
...
//			}
//			
//			com.rays.sql.Connection.setQueryCachingEnabled(true);
//			
...
//	//		String[] servers = { "10.0.0.225:11211" };
//			SockIOPool cacheConnectionPool = null;
//			cacheConnectionPool = SockIOPool.getInstance( COSARDriver.SOCK_POOL_NAME );
...
//			cacheConnectionPool.setMaxConn( 100 );
...
//			
//			// Create functions used by triggers
//			com.rays.sqltrig.SQLTrigUtility.RegFunctions(driver, urls, user, passwd);
//			
//			// Add triggers to registration queue for registration prior to starting the experiment
//			HashMap<String, ByteIterator> result = new HashMap<String, ByteIterator>();
//			viewProfile(1, 1, result, false, false);
//			
//			Vector<HashMap<String, ByteIterator>> result_vec = new Vector<HashMap<String, ByteIterator>>();
//			viewFriendReq(1, result_vec, false, false);
//
//			result_vec = new Vector<HashMap<String, ByteIterator>>();
//			listFriends(1, 1, null, result_vec, false, false);
//			
//			result_vec = new Vector<HashMap<String, ByteIterator>>();
//			viewCommentOnResource(1, 1, 1, result_vec);
//			
//			result_vec = new Vector<HashMap<String, ByteIterator>>();
//			viewTopKResources(1, 1, 5, result_vec);
//			
//			try {
//				Thread.sleep(10000);
...
//		try {
//            proc = conn.prepareStatement("call ACCEPTFRIEND(?, ?)");
...
//		PreparedStatement proc = null;
//		try {
//            proc = conn.prepareStatement("{ call REJECTFRIEND(?, ?) }");
//			proc.setInt(1, inviterID);
//		    proc.setInt(2, inviteeID);
//		    proc.execute();
//		}catch(SQLException sx){
...
//		PreparedStatement proc = null;
//		try {
//            proc = conn.prepareStatement("{ call INVITEFRIEND(?, ?) }");
//			proc.setInt(1, inviterID);
//		    proc.setInt(2, inviteeID);
//		    proc.execute();
//		}catch(SQLException sx){
...
//		PreparedStatement proc = null;
//		try {
//            proc = conn.prepareStatement("{ call THAWFRIEND(?, ?) }");
