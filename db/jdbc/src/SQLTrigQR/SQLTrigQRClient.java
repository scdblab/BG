...
import com.rays.sql.COSARDriver;
...
//			}
	...
	public int insertEntity(String entitySet, String entityPK, HashMap<String, ByteIterator> values, boolean insertImage) {
		return common.RdbmsUtilities.insertEntity(entitySet, entityPK, values, insertImage, conn, FSimagePath);
	}
	...
	public int viewProfile(int requesterID, int profileOwnerID,
		...
		//System.out.println("ViewProfile " + requesterID);
	...
	public int inviteFriend(int inviterID, int inviteeID) {
		...
		try {
			...
			retVal = -2;
			sx.printStackTrace(System.out);
			System.out.println("inviter: " + inviterID + ", invitee: " + inviteeID);
		}finally{
			try {
				if(preparedStatement != null)
					preparedStatement.clearParameters();
	...
	public int thawFriendship(int friendid1, int friendid2){
		...
		try {
			...
			if(ExecuteUpdateStmt(preparedStatement, "friendship") != true) {
				System.out.println("Error deleting from friendship table");
			}
		}catch(SQLException sx){
			retVal = -2;
			sx.printStackTrace(System.out);
